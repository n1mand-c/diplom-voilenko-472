      ...
      <div className="flex items-center gap-4 mb-10">
        {[1, 2, 3].map((s) => (
          <div key={s} className="flex items-center gap-3">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-colors ${step >= s ? "bg-[#C8102E] text-white" : "bg-white/10 text-white/40"
              }`}>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <DatePicker
                        ...
                        minDate={form.checkIn ? new Date(new Date(form.checkIn).getTime() + 86400000) : new Date(new Date().setHours(0, 0, 0, 0))}
                      />
                    </div>
                    <div>
                      <label className="text-white/50 text-sm mb-1.5 block">Кількість гостей</label>
                      <Input
                        value={parseInt(form.guests) || 1}
                  ...
                  <>
                    ...
                    <div className="flex gap-3 mb-6">
                      <button
                        ...
                        className={`flex-1 flex items-center gap-2 p-4 rounded-xl border transition-all ${form.paymentMethod === "card" ? "border-[#C8102E] bg-[#C8102E]/10" : "border-white/10 bg-white/5 hover:border-white/20"
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`flex-1 flex items-center gap-2 p-4 rounded-xl border transition-all ${form.paymentMethod === "transfer" ? "border-[#C8102E] bg-[#C8102E]/10" : "border-white/10 bg-white/5 hover:border-white/20"
                          }`}
                      >
