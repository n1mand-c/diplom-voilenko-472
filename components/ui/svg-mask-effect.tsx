...
export const MaskContainer = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative h-screen w-full transition-colors duration-300",
        className
      )}
    >
      {/* Revealed overlay — shows the masked content on hover */}
      <motion.div
        className="absolute inset-0 flex h-full w-full items-center justify-center bg-[#C8102E]"
        style={{
      ...
      >
        <div className="absolute inset-0 z-0 h-full w-full bg-[#C8102E] opacity-80" />
        <div
